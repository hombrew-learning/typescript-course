...
function () {
  function Eventing() {
    ...
    this.on = function (eventName, callback) {
      if (!Array.isArray(_this.events[eventName])) {
...
function () {
  ...
  ApiSync.prototype.fetchAll = function () {
  ...
  ApiSync.prototype.save = function (data) {
    ...
    return axios_1.default[method](url, data);
  };
...
/** @class */
function () {
  function Collection(sync, deserialize) {
    this.sync = sync;
  ...
  Collection.prototype.fetchAll = function () {
    ...
    this.sync.fetchAll().then(function (response) {
...
},{"./Eventing":"src/models/Eventing.ts"}],"src/models/User.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  User.createCollection = function () {
    return new Collection_1.Collection(new ApiSync_1.ApiSync(rootUrl), function (json) {
...
var userEdit = new UserEdit_1.UserEdit(document.getElementById('root'), User_1.User.create({
  name: 'NAME',
  age: 30
}));
userEdit.render();
